...
<div class="header bg-gradient-default pb-8 pt-5 pt-md-8">
                    ...
                    <div class="card shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0">Data Murojaah</h3>
                                </div>
                                <div class="col-3 text-right">
                                    <input id="myInput" type="text" placeholder="Cari Siswa ..." class="form-control form-control-alternative form-control-sm">
                                </div>
                                <div class="col-2">
                                    <button type="button" data-toggle="modal" data-target="#tambah" class="btn btn-info">Tambah Murojaah</button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="col"> <h3 class="mb-0">Tambah Setoran Murojaah</h3> </div>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                </div>
                <form action="<?= site_url('murojaah/tambah') ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlah" class="form-control form-control-alternative form-control-sm" placeholder="Jumlah Murojaah Yang Di Setorkan" required>
                                </div>
                                <div class="form-group">
    ...
    <?php foreach($murojaah as $row){ ?>
        <div class="modal fade" id="edit<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <div class="col"> <h3 class="mb-0">Edit Murojaah <?= $row->nama ?></h3> </div>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                </div>
                <form action="<?= site_url('murojaah/edit/'.$row->id) ?>" method="POST">
                <div class="modal-body bg-secondary">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Jumlah Halaman</label>
                                    <input type="number" name="jumlah" class="form-control form-control-alternative form-control-sm" placeholder="Jumlah Murojaah Yang Di Setorkan" required value="<?= $row->jumlah ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Keterangan</label>
    ...
    <div class="modal fade" id="delete<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
            <div class="modal-content bg-gradient-danger">
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-notification">Hapus Murojaah | <?= $row->nama ?></h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="py-3 text-center">
                    ...
                    <p>Apakah Anda Yakin Untuk Menghapus Setoran Murojaah .</p>
                    <strong><?= $row->nama ?></strong>
                    <p>Pada Tanggal <?= $row->tanggal ?></p>
                </div>
                </div>
                <form action="<?= site_url('murojaah/delete/'.$row->id) ?>" method="POST">
                <div class="modal-footer">
